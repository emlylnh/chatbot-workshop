...
def load_data():
    ...
    Settings.llm = Gemini(
        ...
        temperature=1.0,
        system_prompt="""You are an expert on the the SJSU Hospitality Guidelines.
        Answer the question using the provided documents, which contain the guide for Hospitality Guidelines.
        The context for all questions is the SJSU Hospitality Guideline. Whenver possible, include a quotation from the provided excerpts of the guide to illustrate your point.
        Respond using a direct tone.
